 ...
 *			         understand the implication and result of
 *disabling module.
 *
 ...
 *				(k) SLEEP_FOREVER - Sleep without waking up
 *through WDT
 *
 ...
 *				(b) USART0_ON - Leave USART0 module in its
 *default state
 *
 ...
 *				(b) TIMER4_ON - Leave Timer 4 module in its
 *default state
 *
 * 4. timer3		Timer 3 module disable control:
 *				(a) TIMER3_OFF - Turn off Timer 3 module
 *				(b) TIMER3_ON - Leave Timer 3 module in its
 *default state
 *
 ...
 *				(b) USART1_ON - Leave USART1 module in its
 *default state
 *
 ...
 *				(b) TIMER5_ON - Leave Timer 5 module in its
 *default state
 *
 ...
 *				(b) USART3_ON - Leave USART3 module in its
 *default state
 *
 * 11.usart2		USART2 module disable control:
 *				(a) USART2_OFF - Turn off USART2  module
 *				(b) USART2_ON - Leave USART2 module in its
 *default state
 *
 ...
 *			   you understand the implication and result of
 *disabling module. Take note that extra Timer 5, 4, 3 compared to an
 *ATmega328P/168. Also take note that extra USART 1 compared to an
 *ATmega328P/168.
 *
 * Argument  	Description
 * =========  	===========
 ...
 *			   a very useful state when using the ADC to achieve
 *best and low noise signal.
 *
 * Argument  	Description
 * =========  	===========
 * 1. period     Duration of low power mode. Use SLEEP_FOREVER to use other wake
 ...
 *			   the lowest current consumption state. Use this
 *together with external pin interrupt to wake up through external event
 ...
 * 			   peripheral management (disabling and shutting down)
 *to achieve the desired current consumption.
 *
 * Argument  	Description
 * =========  	===========
